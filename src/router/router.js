...
export const otherRouter = {
    ...
    component: Main,
    children: [
        { path: 'prePrduct/singleDeploy/:deploy_id', title: '预生产单台部署', name: 'single-deploy', component: resolve => { require(['@/views/deploy/pre-single-deploy.vue'], resolve); } }, // 用于展示动态路由
...
export const appRouter = [
    {
        ...
        component: Main,
        children: [
            { path: 'preProduct', title: '灰度发布', name: 'pre-product', icon: 'edit', component: resolve => { require(['@/views/deploy/pre-product.vue'], resolve); } },
            { path: 'searchableTable', title: '生产发布', name: 'searchable-table', icon: 'search', component: resolve => { require(['@/views/tables/searchable-table.vue'], resolve); } },
            ]
    },
    // {
    //     path: '/access',
